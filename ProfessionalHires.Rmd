...
ggplot(data = profhires.df, aes(x = Year, y = Percentage)) +
  geom_point() +
  stat_smooth(method=lm)


linearModel <- lm(Percentage ~ Year * College, data = profhires.df,) 

grid <- profhires.df %>% 
  data_grid(Year, Percentage) %>% 
  gather_predictions(linearModel)
grid
